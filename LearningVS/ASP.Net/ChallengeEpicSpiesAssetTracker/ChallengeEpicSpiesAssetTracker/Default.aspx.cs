...
namespace ChallengeEpicSpiesAssetTracker
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void addAsset_Click(object sender, EventArgs e)
        {
            ...
            //don't need this as will be the same for all arrays
            //int latestAsset = assets.GetUpperBound(0);
            //int latestElections = elections.GetUpperBound(0);
            //int latestActsOfSubterfuge = actsOfSubterfugePerformed.GetUpperBound(0);

            int newIndex = assets.GetUpperBound(0);

            assets[newIndex] = assetName.Text;
            elections[newIndex] = int.Parse(electionsRigged.Text);
            acts[newIndex] = int.Parse(actsOfSubterfuge.Text);
